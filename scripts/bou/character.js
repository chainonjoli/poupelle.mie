...
(function () {
    ...
    var DEFAULT_CHARACTER = {
        ...
        themes: [
            ...
            /* 悩みリスト由来 */
            '報われない日', 'やろうと思ってるのにできない', '続かない日', '結果が出ない不安',
            '正解がわからない', '自信が持てない日', '時間がなくて焦る', 'やっても意味あるのか'
        ],

        /* 作っている本人の悩みリスト（読者像そのもの）。
         * theme = 投稿テーマ名（コーパス・生成で使う） / worry = 本人の言葉のまま */
        worryThemes: [
            { theme: '報われない日', worry: '頑張ってるのに報われない悩み' },
            { theme: 'やろうと思ってるのにできない', worry: 'やろうと思ってるのにできない葛藤' },
            { theme: '続かない日', worry: '続けたいのに続かない問題' },
            { theme: '比べてしまう日', worry: '周りと比べて落ち込む瞬間' },
            { theme: '結果が出ない不安', worry: '結果が出なくて不安な気持ち' },
            { theme: '正解がわからない', worry: '正解が分からなくて止まる状態' },
            { theme: 'やる気が出ない日', worry: 'やる気が出ない日のリアル' },
            { theme: '自信が持てない日', worry: '自信が持てない瞬間' },
            { theme: '時間がなくて焦る', worry: '時間がない中での焦り' },
            { theme: 'やっても意味あるのか', worry: 'やっても意味あるのか問題' }
        ],
