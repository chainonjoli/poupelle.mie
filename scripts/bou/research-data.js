...
(function () {
    ...
    var SEED = {
        ...
        structures: [
            {
                ...
                carousel: '3〜4枚。1枚目=状態の言い切り／2〜3枚目=言い訳や補足を少しだけ／最後=解決せず「まあ、ええか」の余白で着地',
            ...
            },
            {
                ...
                bouConversion: 'ぼぅ変換例：「考えるん、明日でもええか。」（自分の独り言の形で、相手の肩の力も抜く）',
            ...
            },
            {
                ...
                bouConversion: 'ぼぅ変換例：「ぼくだけの、延長戦やった。」→「ぼくも、忘れよ。」（相手を裁かず自分をゆるす着地）',
            ...
            },
            {
                ...
                empathy: '笑いに寄せすぎない。「だめだね」ではなく「そんなもんやんな」で受け止める',
        ...
        /* ---- 人気構造 → ぼぅ向け変換ルール ---- */
        conversion: [
            { from: '肯定・ねぎらい型（例：〜してえらい！）', to: 'ぼぅは褒めない。「それで、ええ。」と隣に置くだけ。上からではなく横から' },
            { from: '不憫・報われない型', to: '可哀想を笑いにしない。「まあ、いっか」で本人が受け流す形に変換' },
            { from: '疑問形フックでコメント誘導', to: '多用しない。使うなら独り言（「〜でもええか。」）に変換して圧を消す' },
        ...
        /* ---- 投稿戦略の初期値 ---- */
        strategyDefaults: {
            positioning: '「がんばらない」の隣にいる、静かなマンボウ。励まさない・解決しない・急がない。見た人が「まあ、今日はこれでええか」と力を抜ける場所。',
        ...
        phases: [
            ...
            { id: 2, range: '1,000〜5,000', goal: '共感投稿の型を確立し、保存・シェアを増やす', freq: '週4〜5回', themes: '核テーマ＋あるある解像度の高い派生（SNS・予定・考えすぎ）', carouselRatio: 'カルーセル80%・静止画20%', reelRatio: 'リール0〜10%（実験のみ）', series: 'A/B/C型の当たりパターンをシリーズ化', commentCta: '独り言型の余白（「〜でもええか。」）で自然に', fanActivity: '保存を促す「お守り回」を月2回' },
