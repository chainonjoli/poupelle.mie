...
(function (global) {
  ...
  const ART = {
    ...
    /* チャーミー：最後まで姿は見せない。目撃情報は「黄色い影」だけ。
       ギザギザの背ビレがあるマスクの誰か（公式：黄色） */
    charmy() {
      const Y = '#e0bd35';
      const Y_D = '#b8992a';
      return `<svg viewBox="0 0 120 150" xmlns="http://www.w3.org/2000/svg">
        <g fill="${Y}">
          ...
          <!-- 胴（Tシャツ姿の影） -->
          <path d="M44 64 Q60 60 76 64 L78 100 Q60 105 42 100 Z"/>
          <path d="M42 66 Q33 70 32 96 Q32 101 36.5 101 Q41 101 41 96 L43 78 Z"/>
          <path d="M78 66 Q87 70 88 96 Q88 101 83.5 101 Q79 101 79 96 L77 78 Z"/>
          <!-- 脚 -->
          <path d="M46 100 L46 136 Q46 139 50 139 L56 139 L58 102 Z"/>
          <path d="M74 100 L74 136 Q74 139 70 139 L64 139 L62 102 Z"/>
          <!-- くつ -->
          <path d="M45 138 Q44 144 49 144 L59 144 L59 138 Z"/>
          <path d="M75 138 Q76 144 71 144 L61 144 L61 138 Z"/>
        </g>
        <!-- 開いた口の気配（濃いめの影） -->
