  ...
  const CHARACTERS = [
    {
      ...
      name: 'ティラ様',
      sub: 'ピアノ',
      desc: 'バンドのカリスマピアニスト。きらめくブルーのボディに花冠、黒いベルベットスーツで鍵盤を操り、ステージのすべてを支配する。',
      theme: '#2a9dc9',
      themeLight: '#56c8ee',
      skill: {
        name: 'カリスマオーダー',
    ...
    },
    {
      ...
      name: 'カジカジ',
      sub: 'ボーカル',
      desc: '真紅のティラノに白いターバン、カラフルな編み込みがトレードマークの豪快なボーカル。歌も破壊もダイナミック。',
      theme: '#c0392b',
      themeLight: '#e8604a',
      skill: {
        name: 'グランドクラッシュ',
        desc: '魂のシャウトで盤面の下2段をまるごと消し飛ばす。ピンチの立て直しに最強。',
        type: 'crush',
      },
